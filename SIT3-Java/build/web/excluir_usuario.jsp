...
<html>
    ...
    <% 
       ...
       while (i < lista_usuario.size()) {
           %>
           <h3><%= lista_usuario.getItem(i).getItem(1)%> - <%= lista_usuario.getItem(i).getItem(3)%> - <%= lista_usuario.getItem(i).getItem(9)%> - 
               <a href="alterar_usuario_admin.jsp?userid=<%=lista_usuario.getItem(i).getItem(0)%>">[Alterar]</a>
               <a href="excluir_usuario.jsp?action=remove&userid=<%=lista_usuario.getItem(i).getItem(0)%>">[Excluir]</a></h3>
           <%
           i++;
       }
    %>
